...
/**
 * Represents a Room in the Trivia Maze game.
...
public class Room {
    ...
    /**
     * Constructs a Room at the specified grid position with no doors and unvisited.
     *
    ...
    /**
     * Returns the Door in the specified direction, or null if none exists.
     *
     * @param theDirection the direction to check
     * @return the Door in that direction, or null
     */
    ...
    public String toString() {
        return "Room[" + myRow + "][" + myCol + "] visited=" + myVisited
